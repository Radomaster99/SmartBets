...
public class FixturePlayerMatchStatisticDto
{
...
public class FixtureTeamPlayerStatisticsDto
{
    ...
    public IReadOnlyList<FixturePlayerMatchStatisticDto> Players { get; set; } = Array.Empty<FixturePlayerMatchStatisticDto>();
}
