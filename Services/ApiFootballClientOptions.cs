...
public class ApiFootballClientOptions
{
    ...
    public int GetLowDailyRemainingThreshold() => Math.Clamp(LowDailyRemainingThreshold, 1, 75000);
    public int GetCriticalDailyRemainingThreshold() => Math.Clamp(CriticalDailyRemainingThreshold, 1, 75000);
