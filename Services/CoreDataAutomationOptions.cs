...
public class CoreDataAutomationOptions
{
    ...
    public int LiveStatusIntervalSeconds { get; set; } = 45;
    public int LiveStatusEndgameIntervalSeconds { get; set; } = 20;
    ...
    public int FixtureHotLookbackHours { get; set; } = 10;
    ...
    public int OddsMidIntervalHours { get; set; } = 3;
