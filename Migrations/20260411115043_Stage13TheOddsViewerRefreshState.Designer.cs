...
namespace SmartBets.Migrations
{
    ...
    [Migration("20260411115043_Stage13TheOddsViewerRefreshState")]
    partial class Stage13TheOddsViewerRefreshState
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartBets.Entities.TheOddsLeagueMapping", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("ApiFootballLeagueId")
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("TheOddsSportKey")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                    ...
                    b.HasIndex("ApiFootballLeagueId")
                        .IsUnique();

                    b.HasIndex("ResolutionSource");

                    b.HasIndex("TheOddsSportKey");

                    b.ToTable("the_odds_league_mappings", (string)null);
                });

            modelBuilder.Entity("SmartBets.Entities.TheOddsLiveOdd", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("FixtureId", "BookmakerKey", "MarketKey", "CollectedAtUtc");

                    b.HasIndex("FixtureId", "BookmakerKey", "MarketKey", "OutcomeName", "Point", "CollectedAtUtc");

                    b.ToTable("the_odds_live_odds", (string)null);
                });

            modelBuilder.Entity("SmartBets.Entities.TheOddsRuntimeSetting", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("the_odds_runtime_settings", (string)null);
                });
